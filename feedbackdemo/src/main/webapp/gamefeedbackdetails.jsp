...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-container1">
      <div>
        <div class="response">
		 ...
		 <form>  
	<c:forEach var="feed" items="${FeedbackGame}">
	...
	<c:set var ="gname" value ="${feed.gname}"/>
         ...
         <p style="color:  #ffffff" >Feedback <p/>
              ...
              />
               ...
               <p style="color:  #ffffff" >Game Name  <p/>
              <input
                type="text"
                name="feedid"
				value="${feed.gname}"
          ...
          <div class="respose-para">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit,
              maiores? Quo modi autem quasi provident laboriosam molestias
              quibusdam quaerat et error, veniam ad culpa nihil nostrum aliquid
              quisquam ea voluptatibus.
            </p>
          </div>
        </div>
		
        <div class="button-container">
			<c:url value ="gameupdatefeedback.jsp"   var="feedupdate">
        ...
        <div class="button-container">
		<c:url value ="gamedeletefeedback.jsp" var ="feeddelete">

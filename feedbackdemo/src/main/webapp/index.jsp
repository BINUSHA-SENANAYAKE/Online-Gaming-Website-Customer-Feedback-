  ...
  <body>
    ...
    <div class="page-container">
      ...
      <div class="games-area">
		...
		<a href = "feedbackbuttons.jsp">
		<button style="widrth:200px ; height:50px ; border:none ; background-color: #4d4dff;  padding: 15px 32px;
  		text-align: center;  display: inline-block;font-size: 16px;  margin: 4px 2px; cursor: pointer;color: white;">
  		Feedback
  		</button>
		</a>
		</div>
